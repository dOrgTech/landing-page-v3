...
export const hireSelectOptions: HireSelectForms = {
  ...
  raise_funds: [
    {
      value: "Yes, subject to grant approval ",
      label: "Yes, subject to grant approval ",
    },
    {
      value: "Yes, in negotiations with VCs ",
      label: "Yes, in negotiations with VCs ",
    },
    {
      value: "No, we're good ",
      label: "No, we're good ",
